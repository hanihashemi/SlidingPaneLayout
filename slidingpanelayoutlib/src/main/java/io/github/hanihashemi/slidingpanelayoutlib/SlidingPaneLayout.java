package io.github.hanihashemi.slidingpanelayoutlib;
...
public class SlidingPaneLayout extends ViewGroup {
    public static final int ALIGN_RIGHT_TO_LEFT = 0;
    public static final int ALIGN_LEFT_TO_RIGHT = 1;
    ...
    private void readAttributes(Context context, AttributeSet attrs) {
        ...
        try {
            align = a.getInt(R.styleable.SlidingPaneLayout_align, ALIGN_RIGHT_TO_LEFT);
        } finally {
            a.recycle();
        }
    }
    ...
    private boolean isLayoutRtlSupport() {
        return align == ALIGN_RIGHT_TO_LEFT;
    }
